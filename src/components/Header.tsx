  ...
  return (
    <div className="sticky top-0  bg-[#E30019] z-50">
      <div className="m-auto xl:max-w-[1220px] lg:max-w-[1000px] md:max-w-[100%] p-4 flex justify-between items-center">
          ...
          <button className='bg-[#BE1529] hover:bg-red-900  py-1.5 px-2 rounded-md hidden md:flex items-center'><IoMenu className='text-white text-3xl'/><span className='text-white pl-1.5 hidden xl:block'>Danh mục</span></button>
