  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (name && phone && phone.match(/^[0-9]{9,15}$/)) {
        ...
        dispatch(getMe());
      } else toast.error("Thông tin sai cú pháp");
    } catch (error) {
      //
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="mx-auto w-full bg-white">
            <form onSubmit={handleSubmit}>
              ...
              <div>
                <button className="hover:shadow-form w-full rounded-md bg-red-600 hover:opacity-65 py-3 px-8 text-center text-base font-semibold text-white outline-none">
                  Cập nhật
                </button>
              </div>
            </form>
