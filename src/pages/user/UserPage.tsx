...
const UserPage = () => {
  const name = useSelector(
    (state: RootState) => state?.user?.user?.name ?? "Người dùng"
  );
    ...
    <div>
      <div className="m-auto xl:max-w-[1220px] lg:max-w-[1000px] md:max-w-[100%] grid md:grid-cols-6 gap-5 p-4">
        <div className="p-4 md:col-span-2 bg-white rounded-md">
          <ul>
            <li>
              <h2 className="font-medium text-gray-600 text-center pb-4 border-b-[1px]">
                {name}
              </h2>
            </li>
            ...
            >
              <li className="px-2 py-1.5 flex gap-3 items-center">
            ...
            >
              <li className="px-2 py-2 flex gap-3 items-center">
                <LuShoppingCart /> Giỏ hàng của tôi
              </li>
            </NavLink>
            <NavLink
              to={"/user/my-order"}
            ...
            >
              <li className="px-2 py-2  flex gap-3 items-center">
                <IoClipboard /> Quản lý đơn hàng
              </li>
            </NavLink>
            <li
              onClick={handleLogOut}
              className="text-lg cursor-pointer font-medium text-black hover:text-[#E30019] px-2 py-2 flex gap-3 items-center"
            >
              <GrLogout /> Đăng xuất
            </li>
          </ul>
